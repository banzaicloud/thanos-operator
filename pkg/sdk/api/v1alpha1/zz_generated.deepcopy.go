...
*out = *in
if in.HTTPIngressOverrides != nil {
in, out := &in.HTTPIngressOverrides, &out.HTTPIngressOverrides
*out = new(types.MetaBase)
(*in).DeepCopyInto(*out)
}
if in.GRPCIngressOverrides != nil {
in, out := &in.GRPCIngressOverrides, &out.GRPCIngressOverrides
*out = new(types.MetaBase)
(*in).DeepCopyInto(*out)
}
